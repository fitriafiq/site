    ...
    <GridHalf :id="props.content.intro.label">
        <div class="md:pe-16 my-auto">
            ...
            <video data-aos="fade-up" data-aos-duration="1000" data-aos-delay="200" class="block md:hidden my-8" autoplay
                loop playsinline muted :src="colorMode === 'dark' ? config.public.BASE_URL + props.content.visual.visual_dark.data.attributes.url : config.public.BASE_URL + props.content.visual.visual_light.data.attributes.url"></video>
            ...
            <div data-aos="fade-right" data-aos-duration="1000" data-aos-delay="600">
                <button @click="settings.navigateMenu(props.content.button.href)">{{ props.content.button.label
                }}</button>
            </div>
        </div>
